...
var (
	...
	cacheTestStudyUserIdPrefix     = "cache:testStudy:user:id:"
	cacheTestStudyUserMobilePrefix = "cache:testStudy:user:mobile:"
)
...
func (m *defaultUserModel) Delete(ctx context.Context, id int64) error {
	...
	testStudyUserIdKey := fmt.Sprintf("%s%v", cacheTestStudyUserIdPrefix, id)
...
func (m *defaultUserModel) FindOne(ctx context.Context, id int64) (*User, error) {
	testStudyUserIdKey := fmt.Sprintf("%s%v", cacheTestStudyUserIdPrefix, id)
	var resp User
	err := m.QueryRowCtx(ctx, &resp, testStudyUserIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultUserModel) FindOneByMobile(ctx context.Context, mobile string) (*User, error) {
	testStudyUserMobileKey := fmt.Sprintf("%s%v", cacheTestStudyUserMobilePrefix, mobile)
	var resp User
	err := m.QueryRowIndexCtx(ctx, &resp, testStudyUserMobileKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) (i interface{}, e error) {
...
func (m *defaultUserModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheTestStudyUserIdPrefix, primary)
}
